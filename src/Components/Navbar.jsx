        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <Link class="nav-link active" aria-current="page" to="/mens">
                  MEN
                </Link>
              </li>
              <li class="nav-item">
                <Link class="nav-link active" to="/womens">
                  WOMEN
                </Link>
              </li>
          ...
          <form class="d-flex collapse navbar-collapse" id="search">
            ...
            <img
              ...
              height="22px"
              className="logo"
              src="https://cdn4.iconfinder.com/data/icons/top-search-7/128/_heart_love_romantic_favorite_like_active-128.png"
            />
            <img
              width="22px"
              height="22px"
